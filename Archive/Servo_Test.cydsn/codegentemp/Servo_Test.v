// ======================================================================
// Servo_Test.v generated from TopDesign.cysch
// 01/31/2026 at 22:43
...
module top ;
	...
	cy_clock_v1_0
		#(.id("8609dfe8-a53a-428d-80e9-fd66da043a00"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    UART_v2_50_1 UART_1 (
        ...
        .rx_clk(Net_205),
        .rx_data(Net_206),
        .rx_interrupt(Net_191),
        .tx(Net_192),
        .tx_clk(Net_207),
        .tx_data(Net_208),
        .tx_en(Net_209),
        .tx_interrupt(Net_210));
